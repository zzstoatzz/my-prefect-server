...
# UMAP / HDBSCAN parameters — see docs/archive/phi-atlas.md "open questions" for tuning rationale
...
def reduce_to_2d(points: list[AtlasPoint]) -> list[AtlasPoint]:
    ...
    n = len(vectors)
    # n_neighbors scaling per docs/archive/phi-atlas.md open question 5
